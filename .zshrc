...
alias nixswitch="nixos-rebuild switch --use-remote-sudo --flake ~/Code/dotfiles/nixos#willardpad"
alias nixboot="nixos-rebuild boot --use-remote-sudo --flake ~/Code/dotfiles/nixos#willardpad"
